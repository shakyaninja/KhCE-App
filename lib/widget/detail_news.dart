...
class DetailNews extends StatelessWidget {
  DetailNews(
      ...
      this.phone,
      this.about});
  String name, post, location, email, phone, about;
  static final String path = "lib/widget/detail_news.dart";
...
class UserInfo extends StatelessWidget {
  UserInfo({Key key, this.location, this.email, this.phone, this.about});
  String location, email, phone, about;
